...
@app2.route('/productdetail/price')
@app2.route('/productdetail/qty')
@app2.route('/productdetail/category')
@app2.route('/productdetail/supplier')
@app2.route('/productdetail/created')
...
if __name__ == "__main__":
    app2.run(host='0.0.0.0',port=8001,debug=True)